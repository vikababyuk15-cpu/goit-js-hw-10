...
function updateInterface(d, h, m, s) {
  daysValue.textContent = addLeadingZero(d);
  hoursValue.textContent = addLeadingZero(h);
  minutesValue.textContent = addLeadingZero(m);
  secondsValue.textContent = addLeadingZero(s);
}
